...
A simplified version of the convolutional neural network deep learning model proposed by @simonyan2014very. This version only includes a single dense layer (instead of four).
...
A random selection of several rows from a tabular data set on food delivery times.
